...
[<img src="https://obtainium.imranr.dev/badge_obtainium.png"
    ...
    height="80">](https://obtainium.imranr.dev/add.html?url=https://github.com/kamal-v8/luxAlarmPlus)

Or add manually in Obtainium:
1. Open Obtainium → **Add App**
2. Enter the app source URL: `https://github.com/kamal-v8/luxAlarmPlus`
...
git clone https://github.com/kamal-v8/luxAlarmPlus.git
cd luxAlarmPlus
